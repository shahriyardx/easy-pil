...
class Workspace:
    ...
    def add_component(
        ...
        **kwargs
        ...
        identifier_name = identifier if identifier else self.__get_random_identifier()
    ...
    def update_component(self, *, layer_name: str = None, identifier: str, **kwargs):
    ...
    def save_frame(self):
        """Saves the current image as a frame"""
        self.frames.append(self.generate_image().image)
    
    def generate_gif(self):
        """Generates gif from currently saved frames"""
        return Gif(self.size, self.frames)