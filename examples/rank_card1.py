from easy_pil import Font, Canvas, Editor
...
background.bar((30, 220), max_width=650, height=40, percentage=user_data['percentage'] ,fill="#3db374", radius=20)
...
background.text((200, 130), f"Level : {user_data['level']} " + f" XP : {user_data['xp']} / {user_data['next_level_xp']}", font=poppins_small, color="white")
