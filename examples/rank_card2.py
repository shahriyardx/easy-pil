...
background.bar((260, 180), max_width=630, height=40, percentage=user_data['percentage'], fill="#00fa81", radius=20)
background.text((270, 120), user_data['name'], font=poppins, color="#00fa81")
background.text((870, 125), f"{user_data['xp']} / {user_data['next_level_xp']}", font=poppins, color="#00fa81", align="right")
