...
background = Editor(canvas=Canvas((800, 240), color="#23272A"))
...
background.paste(profile.image, (20, 20))
...
background.bar((394, 174), 352, 17, percentage=user_data['percentage'], fill="white", stroke_width=2)
